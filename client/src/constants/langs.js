...
const navbar = {
   ...
   links: {
      en: {
         ...
         "show-balances": "Show Locker Cash",
...
const home = {
   ...
   ar: {
      ...
      "home-shop-btn": "عرض منتجات المتجر",
...
const profile = {
   ...
   ar: {
      ...
      "profile-store-count": "العدد في المخزن:",
      "profile-shop-count": "العدد في المتجر:",
...
const show = {
   shop_store: {
      ...
      ar: {
         "shop-store-title-shop": "عرض بضائع المتجر",
...
const statements = {
   en: {
      ...
      "statement-transfer-switch-label": "Choose The Place",
   ...
   ar: {
      ...
      "statement-transfer-switch-shop": "الي المتجر",
   },
};
...
const creates = {
   ...
   product: {
      ...
      ar: {
         ...
         "creates-product-menu-count-shop": "العدد في المتجر",
...
const analysis = {
   ...
   insufficients: {
      ...
      ar: {
         ...
         "insufficients-from-shop": "نواقص المتجر",
