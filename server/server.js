...
import { SERVER_RESTART } from "./middlewares/verify.middleware.js";
...
app.use("/*", (req, res) => res.status(500).json({ method: req.method, url: req.url, error: "Wronge path." }));
